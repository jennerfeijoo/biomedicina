#!/usr/bin/env python3
"""Build a deterministic manifest for the Bioinstrumentation U2 review packet."""
...
def build_manifest(handoff_path: Path, reviewed_commit: str) -> dict[str, Any]:
    ...
    return {
        ...
        "authorization_scope": "practice_implementation_only",
        "interpretation": "This manifest freezes packet content for review; it is not a review decision and cannot authorize practices.",
    }
