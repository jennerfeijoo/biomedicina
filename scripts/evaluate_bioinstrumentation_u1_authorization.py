#!/usr/bin/env python3
"""Evaluate whether a disciplinary review authorizes controlled drafting."""
...
def evaluate_decision(
    ...
    if authorization:
        status = "authorized_for_controlled_drafting"
    ...
    return {
        ...
        "status": status,
        "controlled_full_theory_drafting_authorized": authorization,
        ...
        "interpretation": "Authorization is limited to controlled drafting. It does not develop the unit, publish content, validate clinical utility or promote the course.",
    }
...
def pending_report(handoff: dict[str, Any]) -> dict[str, Any]:
    return {
        ...
        "interpretation": "No human review evidence is present. CI cannot authorize drafting.",
    }
...
def main() -> int:
    ...
    if args.output:
        ...
        print(rendered, end="")
    if args.require_authorization and not report["controlled_full_theory_drafting_authorized"]:
        return 1
    return 0
