...
PAGE = ROOT / "gestion-etica-comunicacion" / "historia-filosofia-ciencia" / "unidades" / "unidad-02.html"


class HistoriaFilosofiaCienciaUnit02PublicationTests(unittest.TestCase):
    def test_descriptor_and_public_page_match_canonical_purpose(self) -> None:
        ...
        self.assertEqual(detailed[2]["description"], unit["purpose"])
