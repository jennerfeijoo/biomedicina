...
class AcademicCourseSchemaTests(unittest.TestCase):
    ...
    def test_machine_learning_canonical_course_is_structurally_valid(self) -> None:
        ...
        self.assertEqual(report.counts["assessment_items"], 64)
        self.assertEqual(report.counts["claims"], 98)
        ...
        for unit_number in (1, 2, 3, 4, 5, 6, 7):
            unit = json.loads(
        ...
        curated_glossary = [
            ...
            if {"MLBIO-U02", "MLBIO-U03", "MLBIO-U04", "MLBIO-U05", "MLBIO-U06", "MLBIO-U07"}.intersection(entry["unit_ids"])
        ]
