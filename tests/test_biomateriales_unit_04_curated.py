...
# Final user-authored validation trigger after deterministic synchronization.
...
class BiomaterialesUnit04CuratedTests(unittest.TestCase):
    ...
    def test_core_equations_are_relevant_and_limited(self) -> None:
        ...
        self.assertIn(r"f_{rec}=\frac{m_{productos\ recuperados}}{m_{perdida\ del\ especimen}}", equations)
