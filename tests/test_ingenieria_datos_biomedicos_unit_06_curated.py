...
class IngenieriaDatosBiomedicosUnit06Curated(unittest.TestCase):
    ...
    def test_course_is_closed_against_template_detector(self):
        catalog = json.loads(CATALOG.read_text(encoding="utf-8"))
        specificity = catalog["dimensions"]["specificity"]
        self.assertNotIn("ingenieria-datos-biomedicos", specificity["template_detected"])
        self.assertIn("ingenieria-datos-biomedicos", specificity["screened_no_known_template_marker"])
